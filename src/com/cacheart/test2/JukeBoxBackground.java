...
//		PApplet.main(new String[] { "--present", "--hide-stop", "--bgcolor=000000", "com.haxademic.Haxademic" });
		PApplet.main(new String[] {              "--hide-stop", "--bgcolor=000000", "com.cacheart.test2.JukeBoxBackground" });
	}
...
//				perspective(1.0f,1.5f,1f,200000f);
	 ...
	 */
//	public static void main(String args[]) {
//		PApplet.main(new String[] { "--present", "--hide-stop", "--bgcolor=000000", "com.cacheart.test2.TestDrawing2" });
//	}
