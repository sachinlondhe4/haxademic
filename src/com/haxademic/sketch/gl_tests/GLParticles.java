...
//
//public class GLParticles extends PApplet {
...
//	    
//	  sys = new GLModel(this, npartTotal, GLModel.POINTS, GLModel.DYNAMIC);
//	  initColors();
//	  initPositions();
//	  initSprites();
//
...
//
//	void initSprites() {
//	   tex = new GLTexture(this, "images/particle.png");    
...
//	   sys.setMaxSpriteSize(0.9f * pmax);
...
//	      float s = random(0.5f * speed, speed);
...
//	      float a = 1.0f - lifetimes[n] / partLifetime;
//	    
//	      col[0] = 1.0f;
//	      col[1] = 1.0f;
//	      col[2] = 1.0f;
